...
export function AboutOCC() {
  return (
    <section className="relative w-full max-w-[100vw] overflow-x-hidden bg-[#F6F7FA] px-4 py-20 sm:px-6 md:px-12 md:py-28">
        ...
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2 md:gap-24 lg:gap-32">
          <div className="flex flex-col gap-8">
            ...
            <MovableBlock id="about-occ-heading">
              ...
              >
                <h2 className="text-[2.25rem] font-medium leading-[1.05] tracking-tighter text-slate-900 sm:text-[3rem] md:text-[3.5rem] lg:text-[4.25rem]">
                  One platform for{" "}
            ...
            <MovableBlock id="about-occ-body">
              ...
              >
                <p className="max-w-[36rem] text-base leading-[1.7] text-slate-600 md:text-lg">
            ...
            <MovableBlock id="about-occ-interests">
              ...
              >
                {interests.map(({ icon: Icon, label }) => (
                  <span
                    key={label}
                    className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-slate-200/60"
                  >
            ...
            {highlights.map(({ icon: Icon, title, desc }, i) => (
              <MovableBlock key={title} id={`about-occ-highlight-${i}`}>
                <motion.div
                  ...
                  className="group flex gap-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 transition-shadow hover:shadow-lg md:p-8"
                >
